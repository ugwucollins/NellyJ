...
export const FooterLink: Footer = [
  ...
  },
  {
    ...
    link: [
      ...
      {
        text: "nellykitchen2025@gmail.com",
        path: "mailto:nellykitchen2025@gmail.com",
      },
...
export const chiefsArrays: Chiefs = [
  {
    ...
    imageUrl: Assets.chiefs_m,
    experience: 12,
    email: "Rasalina@20gmail.com",
    status: "active",
    handle: [{ path: "" }, { path: "" }, { path: "" }, { path: "" }],
  },
  {
    name: "Rasalina de willAmson",
    imageUrl: Assets.chiefs_f1,
    experience: 10,
    email: "willAmson@20gmail.com",
    status: "active",
    handle: [{ path: "" }, { path: "" }, { path: "" }, { path: "" }],
  },
  {
    name: "Rasalina de willAmson",
    imageUrl: Assets.chiefs_m1,
    experience: 7,
    email: "Rasalina@20gmail.com",
    status: "active",
    handle: [{ path: "" }, { path: "" }, { path: "" }, { path: "" }],
  ...
  {
    name: "Rasalina de willAmson",
    imageUrl: Assets.chiefs_f2,
    experience: 5,
    email: "Rasalinade@20gmail.com",
    status: "active",
    handle: [{ path: "" }, { path: "" }, { path: "" }, { path: "" }],
  },
  {
    name: "Rasalina de willAmson",
    imageUrl: Assets.chiefs_m2,
    experience: 10,
    email: "Rasalina@20gmail.com",
    status: "active",
    handle: [{ path: "" }, { path: "" }, { path: "" }, { path: "" }],
