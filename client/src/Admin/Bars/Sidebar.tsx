...
import { BiSolidArrowFromRight, BiX } from "react-icons/bi";
...
import { SideBarMenu } from "../context/AdminContent";

const Sidebar = () => {
  const { HandleLogOut }: any = UserAdminAuth();
  ...
  return (
    <div className="w-auto sticky top-0 z-[2]">
      <div>
        {openModal && (
          <Modal
            Title="Are you Sure You want to Logout From the Admin Dashboard"
            OkayBtn="Yes"
